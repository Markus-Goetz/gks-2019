            ...
            \begin{figure}
                \begin{tikzpicture}
                    \begin{axis}[
                        width=\linewidth, 
                        grid=both,
                        grid style={line width=.3pt, draw=hgfblue!10},
                        major grid style={line width=.3pt, draw=hgfblue!10},
                        minor tick num=3,
                        xlabel={$x$},
                        ylabel={$y$}, 
                        ticks=none,
                    ...
                    \only<1->{\addplot [hgfblue, only marks, mark size=1pt] coordinates {
                    ...
                    \node<1-> at (axis cs:1.8,0.5) [hgfblue] {\footnotesize\emph{data}};
                    
                    \only<2->{\addplot [hgfhealth, thick, mark=none] {0.5*x};}
                    \node<2-> at (axis cs:2.0,1.3) [hgfhealth] {\footnotesize\emph{model}};
                    \end{axis} 
                \end{tikzpicture}
            \end{figure}
        \end{column}
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [hgfhealth, thick, mark=none, dashed, domain=0:4] {0.1*(x - 1.5) + 0.75};
            \node at (axis cs:0.3,0.7) [hgfhealth] {\footnotesize$w_{1}$};
            \addplot [hgfhealth, thick, mark=none, dashed, domain=0:4] {0.25*(x - 1.5) + 0.75)};
            \node at (axis cs:0.3,0.35) [hgfhealth] {\footnotesize$w_{2}$};
            \addplot [hgfhealth, thick, mark=none] {0.5*x};
            \node at (axis cs:2.2,1.3) [hgfhealth] {\footnotesize$w_{s}$};
            
            
            \addplot [hgfblue, only marks, mark size=1pt] coordinates {
                (0.3, 0.10054215032765762)
                (0.4263157894736842, 0.12363160260273953)
                (0.5526315789473685, 0.2228985962683488)
                (0.6789473684210527, 0.32110283680834006)
            ...
            \node at (axis cs:1.8,0.5) [hgfblue] {\footnotesize\emph{data}};
            \end{axis} 
            \end{tikzpicture}
        \end{figure}
    \end{column}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [hgfhealth, only marks, mark size=2pt] coordinates {
                (1.5, 0.2)
                (1.0, 0.425)
                (0.5, 1.1)
            };
            \addplot [hgfhealth, mark=none] coordinates {
                (1.5, 0.05)
                (1.5, 0.15)
            };
            \addplot [hgfhealth, mark=none] coordinates {
            ...
            \addplot [hgfblue, mark=none] coordinates {
                (0.53, 0.95)
                (0.53, 0.43)
                (0.93, 0.43)
            };
            \draw [->, hgfhealth](axis cs:0.57,1.07)--(axis cs:0.98,0.48);
            \node at (axis cs:1.20,0.8) [hgfblue] {$lr\frac{dJ}{dw}$};
            \node at (axis cs:0.7,0.1) [hgfhealth] {\footnotesize$w_{1}$};
            \node at (axis cs:1.2,0.1) [hgfhealth] {\footnotesize$w_{2}$};
            \node at (axis cs:1.7,0.1) [hgfhealth] {\footnotesize$w_{s}$};
            \end{axis} 
            \end{tikzpicture}
        \end{figure}
    \end{column}
...
\begin{figure}
    ...
    % show origin
    \draw [line width=0.6mm, hgfhealth] (7.05, 4.05) ellipse (0.5 and 0.25);
    \end{tikzpicture}
\end{figure}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            \begin{figure}
                ...
                \addplot [hgfblue, only marks, mark size=2pt, mark=triangle*] coordinates {
                ...
                \addplot [hgfhealth, only marks, mark size=2pt, mark=square*] coordinates {
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [hgfblue, mark=none, smooth, samples=50] {1/(1 + e^-x)};
            \addplot [black, dashed, mark=none] {1};
            \node at (axis cs:2.5,0.5) [hgfblue] {\footnotesize$y=sig(x)$};
            \end{axis}
            \end{tikzpicture}
        \end{figure}
    \end{column}
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{itemize}
            ...
            \begin{itemize}
                \item \tikz{\node[fill=hgfhealth, rectangle ,minimum width=0.2cm,minimum height=0.2cm,inner sep=0pt] at (0,0) {};} $\rightarrow 0$
                \item \tikz{\node[fill=hgfblue, isosceles triangle,isosceles triangle stretches,shape border rotate=90,minimum width=0.2cm,minimum height=0.2cm,inner sep=0pt] at (0,0) {};} $\rightarrow 1$
            \end{itemize}
            \item \textbf{Model:} $h=sig(wx)=\frac{1}{1+e^{-wx}}$
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \node[draw, circle, fill=hgfhealth,  radius=0.3cm] at (1, 1) {};
            \node[draw, circle, fill=hgfhealth,  radius=0.3cm] at (0, 0) {};
            \node[draw, circle, fill=hgfblue, radius=0.3cm] at (1, 0) {};
            \node[draw, circle, fill=hgfblue, radius=0.3cm] at (0, 1) {};
            \end{axis}
            \end{tikzpicture}
        \end{figure}
    \end{column}
...
\begin{columns}
    \begin{column}{0.32\textwidth}
        ...
        \begin{figure}
            ...
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (1, 1) {};
            \node[draw, circle, fill=hgfhealth,  radius=0.05cm] at (0, 0) {};
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (1, 0) {};
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (0, 1) {};
            \addplot[hgfhealth, thick, dashed, mark=none] {-x + 0.5};
            \end{axis}
            \end{tikzpicture}
        \end{figure}
        \end{onlyenv}
    ...
    \begin{column}{0.32\textwidth}
        ...
        \begin{figure}
            ...
            \node[draw, circle, fill=hgfhealth,  radius=0.05cm] at (1, 1) {};
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (0, 0) {};
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (1, 0) {};
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (0, 1) {};
            \addplot[hgfhealth, thick, dashed, mark=none] {-x + 1.5};
            \end{axis}
            \end{tikzpicture}
        \end{figure}
        \end{onlyenv}
    ...
    \begin{column}{0.32\textwidth}
        ...
        \begin{figure}
            ...
            \node[draw, circle, fill=hgfblue, radius=0.05cm] at (1, 1) {};
            \node[draw, circle, fill=hgfhealth,  radius=0.05cm] at (0, 0) {};
            \node[draw, circle, fill=hgfhealth,  radius=0.05cm] at (1, 0) {};
            \node[draw, circle, fill=hgfhealth,  radius=0.05cm] at (0, 1) {};
            \addplot[hgfblue, thick, dashed, mark=none] {-x + 1.5};
            \end{axis}
            \end{tikzpicture}
        \end{figure}
        \end{onlyenv}
...
\begin{columns}
    ...
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \draw[hgfhealth, ->, >=stealth, thick] (hidden1)--(input1.east);
            \draw[hgfhealth, ->, >=stealth, thick] (hidden2)--(input1);
            \draw[hgfhealth, ->, >=stealth, thick] (hidden3)--(input1);
            
            \draw[hgfhealth, ->, >=stealth, thick] (hidden1)--(input2);
            \draw[hgfhealth, ->, >=stealth, thick] (hidden2)--(input2);
            \draw[hgfhealth, ->, >=stealth, thick] (hidden3)--(input2);
            
            \draw[hgfhealth, ->, >=stealth, thick] (output)--(hidden1);
            \draw[hgfhealth, ->, >=stealth, thick] (output)--(hidden2);
            \draw[hgfhealth, ->, >=stealth, thick] (output)--(hidden3);
...
\frametitle{Activation Functions}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            width=0.3\linewidth, 
            grid=major,
            grid style={dashed, line width=.3pt, draw=hgfblue!10},
            major grid style={line width=.3pt, draw=hgfblue!10},
            xlabel={$x$},
            ylabel={$a(x)$},
            xmin=-2,
        ...
        \addplot [hgfblue, thick, mark=none, smooth, samples=50] {1/(1+e^(-x))};
        \end{axis} 
    ...
    \addplot [hgfblue, thick, mark=none, smooth, samples=50] {tanh(x)};
    \end{axis}
    \end{tikzpicture}\begin{tikzpicture}
        \begin{axis}[
            title=ReLU,
        ...
        \addplot [hgfblue, thick, mark=none, domain=-3:3] {max(0, x)};
        \end{axis}
    \end{tikzpicture}\begin{tikzpicture}
        \begin{axis}[
            title=SeLU,
        ...
        \addplot [hgfblue, thick, mark=none, smooth, samples=50, domain=-3:0]{1.0507 * 1.6732 * (e^x - 1)};
        \addplot [hgfblue, thick, mark=none, smooth, samples=50, domain=0:3]{x};
        \end{axis}
    \end{tikzpicture}
    \end{figure}
\end{frame}
...
\begin{itemize}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[draw, thick, rectangle, align=center, minimum width=1.8cm, minimum height=0.8cm, inner sep=0cm, fill=hgfhealth!30] (node12) at (1.5, 1) {\tiny features};
            \node[draw, thick, rectangle, align=center, minimum width=1.8cm, minimum height=0.8cm, inner sep=0cm, fill=hgfhealth!30] (node11) at (1.5, 0) {\tiny simple features};
            
            \node[draw, thick, rectangle, align=center, minimum width=1.8cm, minimum height=0.8cm, inner sep=0cm, fill=hgfhealth!30] (node23) at (4, 2) {\tiny mapping};
            \node[draw, thick, rectangle, align=center, minimum width=1.8cm, minimum height=0.8cm, inner sep=0cm, fill=hgfhealth!30] (node22) at (4, 1) {\tiny mapping};
            \node[draw, thick, rectangle, align=center, minimum width=1.8cm, minimum height=0.8cm, inner sep=0cm, fill=hgfhealth!30] (node21) at (4, 0) {\tiny abstract\\[-5pt]\tiny features};
            
            \node[draw, thick, rectangle, align=center, minimum width=1.8cm, minimum height=0.8cm, inner sep=0cm, fill=hgfhealth!30] (node31) at (6.5, 0) {\tiny mapping};
            ...
            \node[fill=hgfhealth!30] at (3.18, -0.75) {};
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \node[draw, hgfhealth, circle, thick, minimum size=0.8cm] (output1) at (2, -1) {\footnotesize$\hat{y}_1$};
            \node[draw, hgfhealth, circle, thick, minimum size=0.8cm] (output2) at (2, 0) {\footnotesize$\hat{y}_2$};
            \node[draw, hgfhealth, circle, thick, minimum size=0.8cm] (output3) at (2, 1) {\footnotesize$\hat{y}_3$};
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [hgfblue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [hgfhealth, thick, mark=none] {0.036};
        ...
        \end{figure}\begin{figure}
            ...
            \addplot [hgfblue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [hgfhealth, thick, mark=none, smooth, samples=200, domain=0:1] {18.6580627*x^3-28.0637985*x^2+9.40931656*x+0.0228460191};
            \addplot [black, only marks, mark size=1pt, mark=*] coordinates {
                (0.0, 0.5)
                (0.1111111111111111, 0.6527876096865393)
                (0.2222222222222222, 0.984807753012208)
    ...
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [hgfblue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [hgfhealth, thick, mark=none, smooth, samples=10] {-1.28635944*x+0.67917972};
            \addplot [black, only marks, mark size=1pt, mark=*] coordinates {
                (0.0, 0.5)
                (0.1111111111111111, 0.6527876096865393)
                (0.2222222222222222, 0.984807753012208)
        ...
        \end{figure}\begin{figure}
            ...
            \addplot [hgfblue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [hgfhealth, thick, mark=none, smooth, samples=400, domain=0:1] {111819.288*x^9-500987.486*x^8+941671.207*x^7-964004.431*x^6+583394.102*x^5-211630.179*x^4+44379.6659*x^3-4855.25776*x^2+213.040344*x+0.0500000001};
            \addplot [black, only marks, mark size=1pt, mark=*] coordinates {
                (0.0, 0.5)
                (0.1111111111111111, 0.6527876096865393)
                (0.2222222222222222, 0.984807753012208)
...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            % domain=0.25:2.75
            \addplot [hgfhealth, thick, mark=none, smooth, samples=50, domain=0:3] {e^(-4*(x-0.6)) + 0.1 + 0.2*x};
            \addplot [hgfblue, thick, mark=none, smooth, samples=50, domain=0:3] {e^(-4*(x-0.4)) + 0.2};
            \draw[<->, black, >=stealth, thick] (axis cs:1.3,0.25)--(axis cs:1.3,0.4);
            \node at (axis cs:2.5,0.8) [hgfhealth]  {\footnotesize Test loss};
            \node at (axis cs:2.5,0.3) [hgfblue] {\footnotesize Training loss};
...
\begin{columns}
    ...
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \node[draw, thick, hgfblue, minimum height=0.6cm, minimum width=0.6cm, rotate=45] at (axis cs: 0,0) {};
            \node[draw, thick, hgfblue, minimum height=1.2cm, minimum width=1.2cm, rotate=45] at (axis cs: 0,0) {};
            \node[draw, thick, hgfblue, minimum height=1.8cm, minimum width=1.8cm, rotate=45] at (axis cs: 0,0) {};
            \end{axis}
            ...
            \draw[thick, hgfblue] (axis cs: 0, 0) circle[radius=0.5];
            \draw[thick, hgfblue] (axis cs: 0, 0) circle[radius=1.0];
            \draw[thick, hgfblue] (axis cs: 0, 0) circle[radius=1.5];
            \end{axis}
            \end{tikzpicture}
        \end{figure}
    \end{column}
...
\begin{columns}
    ...
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \begin{tikzpicture}
                \node[draw, fill=hgfblue!30, rectangle, minimum width=1cm, minimum height=1cm] (1) at (0,0) {1};
                \node[draw, fill=hgfblue!30, rectangle, minimum width=1cm, minimum height=1cm] (2) at (1,0) {1};
                \node[draw, fill=hgfblue!30, rectangle, minimum width=1cm, minimum height=1cm] (3) at (0,1) {4};
                \node[draw, fill=hgfblue!30, rectangle, minimum width=1cm, minimum height=1cm] (4) at (1,1) {6};
                ...
                \node[draw, fill=hgfhealth!30, rectangle, minimum width=1cm, minimum height=1cm] (9) at (0,2) {3};
                \node[draw, fill=hgfhealth!30, rectangle, minimum width=1cm, minimum height=1cm] (10) at (1,2) {2};
                \node[draw, fill=hgfhealth!30, rectangle, minimum width=1cm, minimum height=1cm] (11) at (0,3) {1};
                \node[draw, fill=hgfhealth!30, rectangle, minimum width=1cm, minimum height=1cm] (12) at (1,3) {1};
                ...
                \node[draw, fill=hgfblue!30, rectangle, minimum width=1cm, minimum height=1cm] (13) at (1,-3) {6};
                \node[draw, fill=hgfgreen!30, rectangle, minimum width=1cm, minimum height=1cm] (14) at (2,-3) {8};
                \node[draw, fill=hgfhealth!30, rectangle, minimum width=1cm, minimum height=1cm] (15) at (1,-2) {3};
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            ymajorgrids=true,
            xtick={0, 1, 2, 3, 4, 5, 6},
            xticklabels={ILSVRC10, ILSVRC11, AlexNet, ILSVRC12, VGG, Inception, ResNet},
            x tick label style={font=\tiny}
        ]
        \addplot+[hgfblue, mark=none, very thick, label=barplot] coordinates {
            (0, 0.282)
            (1, 0.258)
            (2, 0.164)
            (3, 0.117)
...
\begin{columns}
    \begin{column}{0.38\textwidth}
        \begin{itemize}
            ...
            \item Core concepts Inception module
            \begin{itemize}
