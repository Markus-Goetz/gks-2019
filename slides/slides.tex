...
\begin{columns}
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [blue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [red, thick, mark=none] {0.036};
        ...
        \end{figure}\begin{figure}
            ...
            \addplot [blue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [red, thick, mark=none, smooth, samples=200, domain=0:1] {18.6580627*x^3-28.0637985*x^2+9.40931656*x+0.0228460191};
            \addplot [black, only marks, mark size=1pt, mark=*] coordinates {
                (0.0, 0.5)
                (0.1111111111111111, 0.6527876096865393)
                (0.2222222222222222, 0.984807753012208)
    ...
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \addplot [blue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [red, thick, mark=none, smooth, samples=10] {-1.28635944*x+0.67917972};
            \addplot [black, only marks, mark size=1pt, mark=*] coordinates {
                (0.0, 0.5)
                (0.1111111111111111, 0.6527876096865393)
                (0.2222222222222222, 0.984807753012208)
        ...
        \end{figure}\begin{figure}
            ...
            \addplot [blue, thick, mark=none, smooth, samples=200] {sin(deg(2*pi*x))};
            \addplot [red, thick, mark=none, smooth, samples=400, domain=0:1] {111819.288*x^9-500987.486*x^8+941671.207*x^7-964004.431*x^6+583394.102*x^5-211630.179*x^4+44379.6659*x^3-4855.25776*x^2+213.040344*x+0.0500000001};
            \addplot [black, only marks, mark size=1pt, mark=*] coordinates {
                (0.0, 0.5)
                (0.1111111111111111, 0.6527876096865393)
                (0.2222222222222222, 0.984807753012208)
    ...
    \begin{column}{0.48\textwidth}
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \node[draw, fill=hgfkeytechnologies!30, rectangle, minimum width=1cm, minimum height=1cm] (9) at (0,2) {3};
                \node[draw, fill=hgfkeytechnologies!30, rectangle, minimum width=1cm, minimum height=1cm] (10) at (1,2) {2};
                \node[draw, fill=hgfkeytechnologies!30, rectangle, minimum width=1cm, minimum height=1cm] (11) at (0,3) {1};
                \node[draw, fill=hgfkeytechnologies!30, rectangle, minimum width=1cm, minimum height=1cm] (12) at (1,3) {1};
                ...
                \node[draw, fill=hgfkeytechnologies!30, rectangle, minimum width=1cm, minimum height=1cm] (15) at (1,-2) {3};
